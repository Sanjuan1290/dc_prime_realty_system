  ...
  return (
    <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex flex-col gap-3 xl:flex-row xl:items-end xl:justify-between">
        <div>
          <p className="flex items-center gap-2 text-sm font-black text-slate-950"><FiCalendar /> Report Date Filter</p>
...
const Reports = () => {
  ...
  const handleExportPdf = async () => {
    if (!canExport || !canLoadRange || isExporting) return
  ...
  return (
    <main className="flex flex-col gap-6">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <PageHeader title="Reports" description="Company sales, reservations, cancellations, inventory, collections, and performance reporting." icon={FiLayers} />
      ...
      {exportAlert ? <StatusAlert type={exportAlert.type} message={exportAlert.message} onClose={exportAlert.type === 'loading' ? undefined : () => setExportAlert(null)} /> : null}
      ...
      {administratorNeedsConfirmation ? (
