  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      >
        ...
        <DetailBox
          label="Protected Account Folder"
          value={(unitData.accountReference || unitData.account_reference)
            ? `${project?.storageCode || project?.lot_project_storage_code || 'PRJ-'}/accounts/${unitData.accountReference || unitData.account_reference}`
            : '-'}
        />
