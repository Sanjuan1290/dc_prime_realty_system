...
const AddProjectModal = ({ setIsAddProjectModalOpen } : Props) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 p-4 backdrop-blur-sm">
                ...
                <div className="flex max-h-[92vh] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl">
                    ...
                    <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
                        ...
                        <FiX onClick={() => {setIsAddProjectModalOpen(false)}} className="h-9 w-9 cursor-pointer rounded-xl border border-slate-200 bg-white p-2 text-slate-500 duration-300 hover:border-red-200 hover:bg-red-50 hover:text-red-600"/>
                    </div>
