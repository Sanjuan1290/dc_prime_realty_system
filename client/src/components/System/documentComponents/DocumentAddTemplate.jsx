        ...
        <div className="flex items-center justify-between border-b border-slate-200 px-6 py-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              Create a checklist group from existing document library items.
            </p>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <label className="flex flex-col gap-2">
              ...
              <input
                ...
                placeholder="Example: Standard Lot Buyer Checklist"
          ...
          <div className="mt-5 flex flex-col gap-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Add documents to this template. Projects can still customize the list later.
              </p>
            </div>
