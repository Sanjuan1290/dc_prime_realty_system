    ...
    <div className="flex-1 overflow-y-auto p-5">
      ...
      {data ? <>
        <section className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">{[
          ...
          ['Status', String(data.cash_advance_status).toUpperCase()], ['Request Date', data.request_date], ['Start Deduction', data.start_deduction_date], ['Per Payroll', money(data.deduction_per_payroll)],
