                ...
                <div className={`grid gap-4 ${isSellerRole ? "grid-cols-1" : "md:grid-cols-[2fr_1fr]"}`}>
                  ...
                  {!isSellerRole ? (
                    <div className="rounded-xl border border-blue-100 bg-blue-50 px-4 py-3">
                      <p className="text-sm font-black text-blue-900">Secure Login Setup</p>
                      <p className="mt-1 text-xs font-semibold leading-5 text-blue-700">
                        A secure temporary password will be generated by the server and sent to the user&apos;s email. The user must change it after the first login.
                      </p>
                    </div>
                  ) : null}
                </div>
