...
export const sendSettingsVerificationCodeEmail = async ({
  ...
  const paymentNotifications = settings?.paymentEntryEmailNotificationEnabled ? 'Enabled' : 'Disabled';
  ...
  const details = [
    ...
    `Add Payment email notifications: ${paymentNotifications}`,
    `Reason: ${reason}`,
  ];
